...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FDFDFD] font-sans text-slate-900 scroll-smooth selection:bg-yellow-200">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center text-left">
          <FadeInSection>
            <div className="space-y-6">
              ...
              <h1 className="text-4xl md:text-6xl font-black text-green-950 leading-[0.95] tracking-tighter">
                Kelola arsip dengan mudah bersama<br/>
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-700 to-yellow-500 text-7xl md:text-8xl">FileXpert.</span>
              </h1>
          ...
          <div className="grid lg:grid-cols-12 gap-10 items-start text-left">
            ...
            <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-5">
              {[
                ...
                <FadeInSection key={i} delay={50 * i}>
                  <div className="p-6 border border-slate-50 rounded-2xl hover:shadow-md transition-all group bg-white shadow-sm text-left">
              ...
              <div className="md:col-span-2">
                <FadeInSection delay={300}>
                  <div className="p-6 bg-green-900 rounded-[1.5rem] text-white flex justify-between items-center gap-4 shadow-lg text-left">
                    <div>
      ...
      <section id="service" className="scroll-mt-4 py-20 px-6 bg-[#F8FAFC]">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
            <div className="md:col-span-2">
              <FadeInSection delay={100}>
                <div className="bg-white rounded-[2rem] p-8 border border-slate-100 hover:border-green-200 shadow-sm transition-all group cursor-pointer h-full text-left">
            ...
            <FadeInSection delay={200}>
              <div className="bg-green-900 rounded-[2rem] p-8 text-white shadow-xl shadow-green-900/10 group cursor-pointer h-full text-left">
                <div className="h-full flex flex-col justify-between">
                  <div>
                    <ShieldCheck className="w-8 h-8 text-yellow-400 mb-6" />
                    <h4 className="text-lg font-black mb-3 leading-none">Penyimpanan Terkelola</h4>
                  </div>
                  <div className="space-y-3">
            ...
            <FadeInSection delay={300}>
              <div className="bg-yellow-400 rounded-[2rem] p-8 shadow-md group cursor-pointer h-full text-left">
                <div className="h-full flex flex-col justify-between">
            ...
            <div className="md:col-span-4">
              <FadeInSection delay={400}>
                <div className="bg-white rounded-[2.5rem] p-8 flex flex-col md:flex-row items-center gap-10 border border-slate-100 text-left">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center text-left">
          ...
          <FadeInSection delay={200}>
            <div className="relative order-1 lg:order-2">
              <div className="bg-green-950 rounded-[3rem] p-8 text-white space-y-6 relative overflow-hidden shadow-xl text-left">
        ...
        <FadeInSection>
          <div className="max-w-5xl mx-auto bg-yellow-400 rounded-[3rem] p-10 md:p-24 space-y-8 relative overflow-hidden shadow-2xl">
            <div className="relative z-10">
              <h3 className="text-4xl md:text-6xl font-black text-green-950 tracking-tighter leading-[0.9] mb-6 text-center">Optimalkan <br/>Ruang Kantor Anda.</h3>
              ...
              <button onClick={() => scrollToSection('footer')} className="bg-green-950 text-yellow-400 px-10 py-4 rounded-2xl font-black text-lg hover:scale-105 transition-all shadow-xl active:scale-95 uppercase tracking-widest text-sm mx-auto flex items-center justify-center">
                Konsultasi Sekarang
              </button>
            </div>
          </div>
      ...
      <footer id="footer" className="bg-white pt-20 pb-10 px-6 border-t border-slate-100 text-left">
        <div className="max-w-5xl mx-auto">
          <div className="grid lg:grid-cols-12 gap-12 mb-16">
            <div className="lg:col-span-5 space-y-6">
              ...
              <div className="flex gap-4">
                {socialLinks.map(({ Icon, url, label }, i) => (
                  <a key={i} href={url} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-slate-50 border border-slate-100 rounded-xl flex items-center justify-center hover:bg-green-700 hover:text-white transition-all shadow-sm">
                    <Icon size={18} />
                  </a>
                ))}
              </div>
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              <ul className="space-y-4 font-bold text-xs text-slate-500">
                ...
                <li><a href="https://api.whatsapp.com/send/?phone=628119272020" className="group flex items-center gap-3 hover:text-green-700 transition-colors"><Phone size={14} /> +62 811-9272-020</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="pt-8 border-t border-slate-100 flex flex-col md:flex-row justify-between items-center gap-4 text-[9px] font-black uppercase tracking-widest text-slate-400">
            <p>© 2024 FILEXPERT BY PERMATA GROUP. AKREDITASI ANRI. SELURUH HAK CIPTA DILINDUNGI.</p>
